...
class ComponentTable:
    ...
    @staticmethod
    def from_spec(spec: ComponentSpecification, capacity: int) -> "ComponentTable":
        ...
        return ComponentTable(spec, data, alive_mask)
    ...
    def write(self, indices: jnp.ndarray, value: jnp.ndarray) -> "ComponentTable":
        ...
        return ComponentTable(self.spec, new_data, new_mask)

    def clear(self, indices: jnp.ndarray) -> "ComponentTable":
        indices = jnp.asarray(indices, dtype=jnp.int32).reshape(-1)
